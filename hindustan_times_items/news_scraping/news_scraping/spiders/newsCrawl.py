...
class NewscrawlSpider(Spider):
    ...
    # subheadings = ['figcaption','#miwInL23P7y8wYxwF1WiDL_story h2'] purposefully omitted this field
    summary = 'h2'
